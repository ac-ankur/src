      ...
      <div className="wrapper site-header__wrapper">
        ...
        <nav className="nav">
          ...
          <ul className="nav__wrapper">
            <li className="nav__item1"><a href="/currencycalculator" className="hover-underline-animation">Currency Calculator</a></li>
            <li className="nav__item1"><a href="/createbeneficiary" className="hover-underline-animation">Send money</a></li>
            ...
            <li className="nav__item1"><a href="/signup" className="hover-underline-animation register">Register</a></li>
          </ul>
        </nav>
      </div>
    </header>
